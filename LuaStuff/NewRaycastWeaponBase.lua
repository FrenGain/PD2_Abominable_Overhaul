...
Hooks:PostHook(NewRaycastWeaponBase, "damage_multiplier", "more_damage_stuff", function(self)

    --Same deal as above
    local multiplier = 1

    --This SHOULD also check for the Heavy Impact damage stuff I threw in? Hopefully
    multiplier = multiplier + 1 - managers.player:upgrade_value("weapon", "heavy_impact_damage_multiplier_1", 1)
    multiplier = multiplier + 1 - managers.player:upgrade_value("weapon", "heavy_impact_damage_multiplier_2", 1)
